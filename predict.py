...
def main():
    ...
    # DETECTORS_CONFIG='./docker/20201117_Chellange_detectors_cascade_rcnn_r50_1x_coco_WF4_val_MST.py'
    # DETECTORS_CHECKPOINT='/home/globus/minSeok/msdet/mmdetection/docker/epoch_28.pth'
