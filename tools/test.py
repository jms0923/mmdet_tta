...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='./testData/smallval/', help='inference images path')
    parser.add_argument('--config', default='./cpconfig.py', help='test config file path')
